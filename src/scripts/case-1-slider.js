...
// Case 1 image carousel — same centered/infinite/draggable behaviour as
// the homepage slider, but the slides are plain images. Ported from
// slider.js with the data-* hooks scoped to this page.
//
...
const viewport = document.querySelector("[data-case-slider]");
const track = viewport?.querySelector("[data-case-slider-track]");
const slides = track ? gsap.utils.toArray("[data-case-slider-slide]", track) : [];
const prevBtn = viewport?.querySelector("[data-case-slider-prev]");
const nextBtn = viewport?.querySelector("[data-case-slider-next]");
